/*  d3.v4.0.0-alpha.28.min.js humanised, beautified by barionleg  */
...
! function(t, n) {
    ...
    function Pt(t, n, e, r, i, a, o) {
        ...
        return function c(t, f, l, h, d) {
            if (!(f > a || l > o || r > h || i > d)) {
                ...
                for (var m = t.nodes, v = (f + h) / 2, b = (l + d) / 2, x = n >= v, M = e >= b, w = M << 1 | x, T = w + 4; T > w; ++w)
                    if (t = m[3 & w]) switch (3 & w) {
                        case 0:
                            c(t, f, l, v, b);
                            break;
                        case 1:
    ...
    function Dt() {
        function t(t) {
                ...
                if (!isNaN(e) && !isNaN(r))
                    if (t.leaf) {
                        var c = t.x,
                            f = t.y;
                        if (null != c)
                            if (Math.abs(c - e) + Math.abs(f - r) < .01) s(t, n, e, r, i, a, o, u);
                            else {
                                var l = t.data;
            ...
            var c, f, l, h, d, p, _, y, g, m = "function" == typeof a ? a : Nt(a),
                v = "function" == typeof o ? o : Nt(o);
            if (t || (t = []), null != n) p = n, _ = r, y = e, g = i;
            else
                for (y = g = -(p = _ = 1 / 0), f = [], l = [], d = t.length, h = 0; d > h; ++h) {
                    var b = +m(c = t[h], h, t),
                        x = +v(c, h, t);
        ...
        return t.x = function(n) {
            ...
            return arguments.length ? (null == a ? n = r = e = i = null : (n = +a[0][0], r = +a[0][1], e = +a[1][0], i = +a[1][1]), t) : null == n ? null : [
                [n, r],
                [e, i]
            ]
        }, t.size = function(a) {
    ...
    function Vt(t, n, e, r, i, a, o) {
        var u = t - e,
            ...
            x = i - a,
            M = h * _ - p * d,
            w = (0 > v ? -1 : 1) * Math.sqrt(Math.max(0, x * x * b - M * M)),
            T = (M * v - m * w) / b,
            k = (-M * m - v * w) / b,
            S = (M * v + m * w) / b,
            A = (-M * m + v * w) / b,
    ...
    function $t() {
        function t() {
            var t, c, f = +n.apply(this, arguments),
                ...
                h = a.apply(this, arguments) - af,
                d = o.apply(this, arguments) - af,
                p = Math.abs(d - h),
                _ = d > h;
            if (s || (s = t = kt()), f > l && (c = l, l = f, f = c), l > ef)
                if (p > of - ef) s.moveTo(l * Math.cos(h), l * Math.sin(h)), s.arc(0, 0, l, h, d, !_), f > ef && (s.moveTo(f * Math.cos(d), f * Math.sin(d)), s.arc(0, 0, f, d, h, _));
                else {
                    var y, g, m = h,
                        v = d,
                        b = h,
                        ...
                        k = T > ef && (i ? +i.apply(this, arguments) : Math.sqrt(f * f + l * l)),
                        S = Math.min(Math.abs(l - f) / 2, +r.apply(this, arguments)),
                        A = S,
                        N = S;
                    if (k > ef) {
                        var C = Bt(k / f * Math.sin(T)),
                            E = Bt(k / l * Math.sin(T));
                    ...
                    if (S > ef) {
                        var U = l * Math.cos(v),
                            ...
                            H = f * Math.sin(b);
                        if (rf > p) {
                            var R = M > ef ? Wt(P, D, O, H, U, Y, F, L) : [F, L],
                                j = P - R[0],
                                z = D - R[1],
                                q = U - R[0],
                                I = Y - R[1],
                                X = 1 / Math.sin(Math.acos((j * q + z * I) / (Math.sqrt(j * j + z * z) * Math.sqrt(q * q + I * I))) / 2),
                                J = Math.sqrt(R[0] * R[0] + R[1] * R[1]);
        ...
        return t.centroid = function() {
            var t = (+n.apply(this, arguments) + +e.apply(this, arguments)) / 2,
                r = (+a.apply(this, arguments) + +o.apply(this, arguments)) / 2 - rf / 2;
    ...
    function tn() {
        function t(t) {
            var c, f, l, h, d, p = t.length,
                _ = !1,
                y = new Array(p),
                g = new Array(p);
            for (null == o && (s = u(d = kt())), c = 0; p >= c; ++c) {
                if (!(p > c && a(h = t[c], c, t)) === _)
    ...
    function an() {
        function t(t) {
            var u, s, c, f, l, h = t.length,
                d = 0,
                p = new Array(h),
                _ = new Array(h),
                y = +i.apply(this, arguments),
                g = Math.min(of, Math.max(-of, a.apply(this, arguments) - y)),
    ...
    function Bn(t, n) {
        if ((r = t.length) > 1)
            for (var e, r, i = 1, a = t[n[0]], o = a.length; r > i; ++i) {
                e = a, a = t[n[i]];
    ...
    function me(t) {
        ...
        var e = Te(t.r),
            r = Te(t.g),
            i = Te(t.b),
            a = xe((.4124564 * e + .3575761 * r + .1804375 * i) / Vf),
            o = xe((.2126729 * e + .7151522 * r + .072175 * i) / $f),
            u = xe((.0193339 * e + .119192 * r + .9503041 * i) / Zf);
    ...
    function Ne(t) {
        ...
        var n = t.r / 255,
            e = t.g / 255,
            r = t.b / 255,
            i = (sl * r + ol * n - ul * e) / (sl + ol - ul),
            a = r - i,
            o = (al * (e - i) - rl * a) / il,
            u = Math.sqrt(o * o + a * a) / (al * i * (1 - i)),
            s = u ? Math.atan2(o, a) * Bf - 120 : NaN;
    ...
    function qe(t, n) {
        var e, r, i, a = pl.lastIndex = _l.lastIndex = 0,
            o = -1,
            u = [],
            s = [];
        for (t += "", n += "";
            (e = pl.exec(t)) && (r = _l.exec(n));)(i = r.index) > a && (i = n.slice(a, i), u[o] ? u[o] += i : u[++o] = i), (e = e[0]) === (r = r[0]) ? u[o] ? u[o] += r : u[++o] = r : (u[++o] = null, s.push({
            i: o,
            x: He(e, r)
        })), a = _l.lastIndex;
    ...
    function Qe(t, n) {
        var e = Le((t = _e(t)).h, (n = _e(n)).h),
            r = Ye(t.s, n.s),
            i = Ye(t.l, n.l),
            a = Ye(t.opacity, n.opacity);
        return function(n) {
    ...
    function hr(t) {
        ...
        function e(t, n) {
            ...
            for (var r, i, a = {}, o = {}, u = [], c = t.length, f = 0, l = 0;
                (r = e()) !== o;) {
    ...
    function dr(t, n) {
        ...
        var r, i, a, o, u = ir("beforesend", "progress", "load", "error"),
            s = L(),
    ...
    function Or(t, n) {
        ...
        var r = e[0],
            i = e[1],
            a = i - (rh = 3 * Math.max(-8, Math.min(8, Math.floor(i / 3)))) + 1,
            o = r.length;
    ...
    function qr(t) {
        function n(t) {
            function n(t) {
                ...
                if ("c" === d) v = y(t) + v, t = "";
                    ...
                    if (t = y(t, h), b)
                        for (n = -1, i = t.length, b = !1; ++n < i;)
                            if (s = t.charCodeAt(n), s > 48 && 58 > s || "x" === d && s > 96 && 103 > s || "X" === d && s > 64 && 71 > s) {
                                b = !0;
                                break
                            } if (m = (b ? "(" === u ? u : "-" : "-" === u || "(" === u ? "" : u) + m, v = v + ("s" === d ? pd[8 + rh / 3] : "") + (b && "(" === u ? ")" : ""), g)
                        for (n = -1, i = t.length; ++n < i;)
                            if (s = t.charCodeAt(n), 48 > s || s > 57) {
                                v = (46 === s ? a + t.slice(n + 1) : t.slice(n)) + v, t = t.slice(0, n);
                                break
                            }
                }
                l && !c && (t = r(t, 1 / 0));
                var x = m.length + t.length + v.length,
                    M = f > x ? new Array(f - x + 1).join(e) : "";
        ...
        function e(t, e) {
            var r = n((t = Rr(t), t.type = "f", t)),
                i = 3 * Math.max(-8, Math.min(8, Math.floor(Lr(e) / 3))),
                a = Math.pow(10, -i),
                o = pd[8 + i / 3];
            return function(t) {
                return r(a * t) + o
        ...
        var r = t.grouping && t.thousands ? Ur(t.grouping, t.thousands) : zr,
            i = t.currency,
            a = t.decimal;
        return {
            format: n,
    ...
    function ho(t) {
        for (var n = this._groups, e = t._groups, r = n.length, i = e.length, a = Math.min(r, i), o = new Array(r), u = 0; a > u; ++u)
            for (var s, c = n[u], f = e[u], l = c.length, h = o[u] = new Array(l), d = 0; l > d; ++d)(s = c[d] || f[d]) && (h[d] = s);
        for (; r > u; ++u) o[u] = n[u];
    ...
    function Bo(t, n) {
        var e = Ho(t + "");
        if (arguments.length < 2) {
            for (var r = Ro(this.node()), i = -1, a = e.length; ++i < a;)
    ...
    function mu(t) {
        return "string" == typeof t ? new yu([
            [document.querySelector(t)]
        ], [document.documentElement]) : new yu([
            [t]
        ], Vp)
    }
    ...
    function Mu(t, n, e) {
        ...
        for (var r, i = 0, a = n ? n.length : 0; a > i; ++i)
            if ((r = n[i]).identifier === e) return vu(t, r);
        return null
    }
    ...
    function Du(t, n) {
        ...
        if (t += "", arguments.length < 2) {
            for (var r, i = Au(this.node(), e).tween, a = 0, o = i.length; o > a; ++a)
    ...
    function os(t) {
        ...
        for (var r = this._groups, i = r.length, a = new Array(i), o = 0; i > o; ++o)
            for (var u, s, c = r[o], f = c.length, l = a[o] = new Array(f), h = 0; f > h; ++h)(u = c[h]) && (s = t.call(u, u.__data__, h, c)) && ("__data__" in u && (s.__data__ = u.__data__), l[h] = s, Tu(l[h], n, e, h, l, Au(u, e)));
    ...
    function us(t) {
        ...
        for (var r = this._groups, i = r.length, a = [], o = [], u = 0; i > u; ++u)
            for (var s, c = r[u], f = c.length, l = 0; f > l; ++l)
                if (s = c[l]) {
    ...
    function cs(t, n) {
        var e, r, i;
        return function() {
            var a = Ka(this).getComputedStyle(this, null),
    ...
    function hs(t, n, e) {
        var r, i, a;
        return function() {
            var o = Ka(this).getComputedStyle(this, null),
    ...
    function vs() {
        for (var t = this._name, n = this._id, e = Ms(), r = this._groups, i = r.length, a = 0; i > a; ++a)
    ...
    function ws(t, n) {
        for (var e; !(e = t.__transition) || !(e = e[n]);)
            if (!(t = t.parentNode)) return u_.time = vr(), u_;
        return e
    }
    ...
    function Ts(t) {
        ...
        for (var r = this._groups, i = r.length, a = 0; i > a; ++a)
            for (var o, u = r[a], s = u.length, c = 0; s > c; ++c)(o = u[c]) && Tu(o, t, n, c, u, e || ws(o, n));
    ...
    function ks(t, n) {
        ...
        if (i) {
            n = null == n ? null : n + "";
            for (r in i)
                if ((e = i[r]).state > Qp && e.name === n) return new bs([
                    [t]
                ], s_, n, +r)
        }
        return null
    ...
    function Es(t, n) {
        function e(e) {
            var c = null == i ? n.ticks ? n.ticks.apply(n, r) : n.domain() : i,
                f = null == a ? n.tickFormat ? n.tickFormat.apply(n, r) : Ss : a,
                l = Math.max(o, 0) + s,
                h = t === f_ || t === h_ ? As : Ns,
                d = n.range(),
                p = d[0],
                _ = d[d.length - 1],
                y = (n.bandwidth ? Cs : Ss)(n.copy()),
                g = e.selection ? e.selection() : e,
                m = g.selectAll(".domain").data([null]),
                v = g.selectAll(".tick").data(c, n).order(),
                b = v.exit(),
                x = v.enter().append("g", ".domain").attr("class", "tick"),
                M = v.select("line"),
                w = v.select("text");
    ...
    function Ws(t, n, e, r, i) {
        ...
        } else if (o = (l - d) / (p - h), u = y - o * _, -1 > o || o > 1)
            if (l > d) {
                if (s) {
                    if (s[1] >= i) return
                } else s = [(e - u) / o, e];
    ...
    function Qs() {
        for (var t, n, e, r, i = 0, a = g_.length; a > i; ++i)
            if ((t = g_[i]) && (r = (n = t.halfedges).length)) {
                var o = new Array(r),
                    u = new Array(r);
    ...
    function tc(t, n, e, r, i) {
        for (var a, o, u, s, c, f, l, h, d, p, _ = g_.length; _--;)
            if (a = g_[_]) {
        ...
        if (n && e) {
            ...
            if (r !== a) {
                ...
                if (!(h >= -w_)) {
                    ...
                    for (var m = null, v = m_._; v;)
                        if (g.y < v.y || g.y === v.y && g.x <= v.x) {
                            if (!v.L) {
                                m = v.P;
                                break
                            }
    ...
    function sc(t) {
        for (var n, e, r, i, a = t[0], o = t[1], u = y_._; u;)
            if (r = cc(u, o) - a, r > M_) u = u.L;
            else {
                if (i = a - fc(u, o), !(i > M_)) {
    ...
    function dc(t, n) {
        ...
        for (v_ = [], g_ = new Array(t.length), y_ = new Hs, m_ = new Hs;;)
            if (i = __, a && (!i || a[1] < i.y || a[1] === i.y && a[0] < i.x)) a[0] === e && a[1] === r || (sc(a), e = a[0], r = a[1]), a = t.pop();
            else {
                if (!i) break;
                uc(i.arc)
            } if (Qs(), n) {
            ...
            this.extent = [
                [o, u],
                [s, c]
            ], this.cellEdges = Vs(o, u, s, c), tc(this.cellEdges, o, u, s, c)
    ...
    F.prototype = L.prototype = {
        ...
        entries: function() {
            var t = [];
            for (var n in this) n[0] === Mc && t.push({
                key: n.slice(1),
                value: this[n]
            });
            return t
            ...
            if (null === this._x1) this._.push("M", this._x1 = t, ",", this._y1 = n);
                ...
                if (Math.abs(f * u - s * c) > Kc && i) {
                    var h = e - a,
                        ...
                        y = Math.sqrt(p),
                        g = Math.sqrt(l),
                        m = i * Math.tan((Zc - Math.acos((p + l - _) / (2 * y * g))) / 2),
                        v = m / g,
                        b = m / y;
    ...
    var uf = {
        ...
        lf = {
            draw: function(t, n) {
                var e = Math.sqrt(n / ff),
                    r = e * cf;
                t.moveTo(0, -e), t.lineTo(r, 0), t.lineTo(0, e), t.lineTo(-r, 0), t.closePath()
            }
        },
        hf = .8908130915292852,
        df = Math.sin(rf / 10) / Math.sin(7 * rf / 10),
        pf = Math.sin(of / 10) * df,
        _f = -Math.cos(of / 10) * df,
        yf = {
            draw: function(t, n) {
                var e = Math.sqrt(n * hf),
                    r = pf * e,
                    i = _f * e;
    ...
    var Ff = Array.prototype.slice,
        ...
        Yf = /^#([0-9a-f]{3})$/,
        Of = /^#([0-9a-f]{6})$/,
        Hf = /^rgb\(\s*([-+]?\d+)\s*,\s*([-+]?\d+)\s*,\s*([-+]?\d+)\s*\)$/,
        Rf = /^rgb\(\s*([-+]?\d+(?:\.\d+)?)%\s*,\s*([-+]?\d+(?:\.\d+)?)%\s*,\s*([-+]?\d+(?:\.\d+)?)%\s*\)$/,
        jf = /^rgba\(\s*([-+]?\d+)\s*,\s*([-+]?\d+)\s*,\s*([-+]?\d+)\s*,\s*([-+]?\d+(?:\.\d+)?)\s*\)$/,
        zf = /^rgba\(\s*([-+]?\d+(?:\.\d+)?)%\s*,\s*([-+]?\d+(?:\.\d+)?)%\s*,\s*([-+]?\d+(?:\.\d+)?)%\s*,\s*([-+]?\d+(?:\.\d+)?)\s*\)$/,
        qf = /^hsl\(\s*([-+]?\d+(?:\.\d+)?)\s*,\s*([-+]?\d+(?:\.\d+)?)%\s*,\s*([-+]?\d+(?:\.\d+)?)%\s*\)$/,
        If = /^hsla\(\s*([-+]?\d+(?:\.\d+)?)\s*,\s*([-+]?\d+(?:\.\d+)?)%\s*,\s*([-+]?\d+(?:\.\d+)?)%\s*,\s*([-+]?\d+(?:\.\d+)?)\s*\)$/,
        Xf = {
            aliceblue: 15792383,
    ...
    ie(Ee, Ce, ae(oe, {
        ...
        rgb: function() {
            var t = isNaN(this.h) ? 0 : (this.h + 120) * Jf,
                n = +this.l,
    ...
    var cl, fl, ll, hl, dl = function j_(t) {
        ...
        Tl = function z_(t) {
            function n(n, e) {
                var r = Le((n = Ce(n)).h, (e = Ce(e)).h),
                    i = Ye(n.s, e.s),
                    a = Ye(n.l, e.l),
                    o = Ye(n.opacity, e.opacity);
                return function(e) {
        ...
        on: function(t, n) {
                ...
                o = i.length;
            {
                if (!(arguments.length < 2)) {
                    ...
                    for (; ++a < o;)
                        if (e = (t = i[a]).type) r[e] = sr(r[e], t.name, n);
                        else if (null == n)
                        for (e in r) r[e] = sr(r[e], t.name, null);
                    return this
                }
                for (; ++a < o;)
                    if ((e = (t = i[a]).type) && (e = ur(r[e], t.name))) return e
            }
        },
        copy: function() {
            var t = {},
    ...
    var Al, Nl, Cl = hr(","),
        ...
        Il = gr("text/csv", El),
        Xl = gr("text/tab-separated-values", Ul),
        Jl = 0,
        Bl = 0,
        Wl = 0,
        Vl = 1e3,
        ...
        Zl = 0,
        Gl = 0,
        Kl = "object" == typeof performance ? performance : Date,
        Ql = "function" == typeof requestAnimationFrame ? requestAnimationFrame : function(t) {
    ...
    var pd = ["y", "z", "a", "f", "p", "n", "µ", "m", "", "k", "M", "G", "T", "P", "E", "Z", "Y"],
        _d = qr({
            decimal: ".",
            thousands: ",",
            grouping: [3],
        ...
        hp = "%Y-%m-%dT%H:%M:%S.%LZ",
        dp = Date.prototype.toISOString ? Ii : Xd.utcFormat(hp),
        pp = +new Date("2000-01-01T00:00:00.000Z") ? Xi : Xd.utcParse(hp),
        _p = Xd.format,
        yp = Xd.parse,
        gp = Xd.utcFormat,
        mp = Xd.utcParse,
        ...
        Cp = 30 * Ap,
        Ep = 365 * Ap,
        Pp = Sa("1f77b4ff7f0e2ca02cd627289467bd8c564be377c27f7f7fbcbd2217becf"),
        ...
        Lp = Sa("1f77b4aec7e8ff7f0effbb782ca02c98df8ad62728ff98969467bdc5b0d58c564bc49c94e377c2f7b6d27f7f7fc7c7c7bcbd22dbdb8d17becf9edae5"),
        Up = Sa(""),
    ...
    var $p = "undefined" != typeof navigator && /WebKit/.test(navigator.userAgentData) ? -1 : 0,
        Zp = ir("start", "end", "interrupt"),
        Gp = [],
        Kp = 0,
        Qp = 1,
        t_ = 2,
